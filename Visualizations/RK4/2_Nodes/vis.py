...
def step():
	global h,t,g,times,N,thetaf,m,l,KP,KD,KI,u
...
def draw():
	...
	line(100*l[0]*cos(u[0]) + 100*l[1]*cos(u[1]),100*l[0]*sin(u[0]) + 100*l[1]*sin(u[1]),100*l[0]*cos(u[0]) + 100*l[1]*cos(u[1])+100*l[2]*cos(u[2]),100*l[0]*sin(u[0]) + 100*l[1]*sin(u[1]) + 100*l[2]*sin(u[2]))
	circle(100*l[0]*cos(u[0]),100*l[0]*sin(u[0]),20)
	circle(100*l[0]*cos(u[0]) + 100*l[1]*cos(u[1]),100*l[0]*sin(u[0]) + 100*l[1]*sin(u[1]),20)
	circle(100*l[0]*cos(u[0]) + 100*l[1]*cos(u[1])+100*l[2]*cos(u[2]),100*l[0]*sin(u[0]) + 100*l[1]*sin(u[1]) + 100*l[2]*sin(u[2]),20)
